...
from atendimento.schemas import (AgendamentoCreate, AgendamentoUpdate,
                                 AtendimentoCreate, AtendimentoUpdate,
                                 AvaliacaoCreate, AvaliacaoUpdate)
from core.cruds import CRUDBase


class CRUDAgendamento(
        CRUDBase[Agendamento, AgendamentoCreate, AgendamentoUpdate]):
    pass
...
class CRUDAtendimento(
        CRUDBase[Atendimento, AtendimentoCreate, AtendimentoUpdate]):
    pass
