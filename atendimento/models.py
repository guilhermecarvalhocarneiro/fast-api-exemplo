...
from usuario.models import Cliente, Profissional

atendimento_agendamento_servico = Table(
    'atendimento_agendamento_servico', Base.metadata, Column(
        'id', Integer, primary_key=True, index=True), Column(
            'agendamento_id', ForeignKey('atendimento_agendamento.id')), Column(
